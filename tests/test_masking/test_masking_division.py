...
def test_non_unique_mask_division(stairs1, stairs2):
...
def test_non_unique_nan_initial_mask_division(stairs1, stairs2):
    result = stairs1 / stairs2
    expected = pd.Series(
        {
            3.0: -5.5,
...
def test_unique_non_overlapping_mask_division(stairs1, stairs2):
    result = stairs1 / stairs2
    expected = pd.Series(
        {
            -2.0: 1.0,
...
def test_unique_non_overlapping_nan_initial_mask_division(stairs1, stairs2):
    result = stairs1 / stairs2
...
def test_unique_adjacent_mask_division(stairs1, stairs2):
    result = stairs1 / stairs2
...
def test_unique_adjacent_nan_initial_mask_division(stairs1, stairs2):
    result = stairs1 / stairs2
...
def test_unique_overlapping_mask_division(stairs1, stairs2):
    result = stairs1 / stairs2
    expected = pd.Series({-2.0: 1.0, 1.0: np.nan, 9.0: -0.1, 10.0: np.nan})
    pd.testing.assert_series_equal(
        result.step_values,
...
def test_unique_overlapping_nan_initial_mask_division(stairs1, stairs2):
    result = stairs1 / stairs2
    expected = pd.Series({9.0: -0.1, 10.0: np.nan})
    pd.testing.assert_series_equal(
        result.step_values,
