...
def test_non_unique_mask_le(stairs1, stairs2):
...
def test_non_unique_nan_initial_mask_le(stairs1, stairs2):
    result = stairs1 <= stairs2
...
def test_unique_non_overlapping_mask_le(stairs1, stairs2):
    result = stairs1 <= stairs2
...
def test_unique_non_overlapping_nan_initial_mask_le(stairs1, stairs2):
    result = stairs1 <= stairs2
...
def test_unique_adjacent_mask_le(stairs1, stairs2):
    result = stairs1 <= stairs2
...
def test_unique_adjacent_nan_initial_mask_le(stairs1, stairs2):
    result = stairs1 <= stairs2
...
def test_unique_overlapping_mask_le(stairs1, stairs2):
    result = stairs1 <= stairs2
    expected = pd.Series({1.0: np.nan, 9.0: 1.0})
    pd.testing.assert_series_equal(
        result.step_values,
...
def test_unique_overlapping_nan_initial_mask_le(stairs1, stairs2):
    result = stairs1 <= stairs2
    expected = pd.Series({9.0: 1.0})
    pd.testing.assert_series_equal(
        result.step_values,
