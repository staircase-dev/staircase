...
def test_non_unique_mask_xor(stairs1, stairs2):
...
def test_non_unique_nan_initial_mask_xor(stairs1, stairs2):
    result = stairs1.logical_xor(stairs2)
...
def test_unique_non_overlapping_mask_xor(stairs1, stairs2):
    result = stairs1.logical_xor(stairs2)
    expected = pd.Series(
...
def test_unique_non_overlapping_nan_initial_mask_xor(stairs1, stairs2):
    result = stairs1.logical_xor(stairs2)
...
def test_unique_adjacent_mask_xor(stairs1, stairs2):
    result = stairs1.logical_xor(stairs2)
...
def test_unique_adjacent_nan_initial_mask_xor(stairs1, stairs2):
    result = stairs1.logical_xor(stairs2)
...
def test_unique_overlapping_mask_xor(stairs1, stairs2):
    result = stairs1.logical_xor(stairs2)
    expected = pd.Series({-4.0: 1.0, -2.0: 0.0, 1.0: np.nan, 9.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values,
...
def test_unique_overlapping_nan_initial_mask_xor(stairs1, stairs2):
    result = stairs1.logical_xor(stairs2)
    expected = pd.Series({9.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values,
