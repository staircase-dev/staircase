...
def test_unique_non_overlapping_mask_multiplication(stairs1, stairs2):
    result = stairs1 * stairs2
    expected = pd.Series(
        {
            -2.0: 3.0625,
...
def test_unique_non_overlapping_nan_initial_mask_multiplication(stairs1, stairs2):
    result = stairs1 * stairs2
...
def test_unique_adjacent_mask_multiplication(stairs1, stairs2):
    result = stairs1 * stairs2
...
def test_unique_adjacent_nan_initial_mask_multiplication(stairs1, stairs2):
    result = stairs1 * stairs2
...
def test_unique_overlapping_mask_multiplication(stairs1, stairs2):
    result = stairs1 * stairs2
    expected = pd.Series({-2.0: 3.0625, 1.0: np.nan, 9.0: -2.5, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values(),
...
def test_unique_overlapping_nan_initial_mask_multiplication(stairs1, stairs2):
    result = stairs1 * stairs2
    expected = pd.Series({9.0: -2.5, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values(),
