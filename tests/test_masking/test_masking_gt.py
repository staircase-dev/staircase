...
def test_non_unique_mask_gt(stairs1, stairs2):
    result = stairs1 > stairs2
    expected = pd.Series({1.0: np.nan, 3.0: 1.0, 7.0: 0.0})
...
def test_non_unique_nan_initial_mask_gt(stairs1, stairs2):
    result = stairs1 > stairs2
    expected = pd.Series({3.0: 1.0, 7.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values,
        expected,
        check_names=False,
...
def test_unique_non_overlapping_mask_gt(stairs1, stairs2):
    result = stairs1 > stairs2
    expected = pd.Series({1.0: np.nan, 3.0: 1.0, 5.0: np.nan, 9.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values,
        expected,
        check_names=False,
...
def test_unique_non_overlapping_nan_initial_mask_gt(stairs1, stairs2):
    result = stairs1 > stairs2
    expected = pd.Series({3.0: 1.0, 5.0: np.nan, 9.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values,
        expected,
        check_names=False,
...
def test_unique_adjacent_mask_gt(stairs1, stairs2):
    result = stairs1 > stairs2
    expected = pd.Series({1.0: np.nan, 9.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values,
        expected,
        check_names=False,
...
def test_unique_adjacent_nan_initial_mask_gt(stairs1, stairs2):
    result = stairs1 > stairs2
...
def test_unique_overlapping_mask_gt(stairs1, stairs2):
    result = stairs1 > stairs2
    expected = pd.Series({1.0: np.nan, 9.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values,
...
def test_unique_overlapping_nan_initial_mask_gt(stairs1, stairs2):
    result = stairs1 > stairs2
    expected = pd.Series({9.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values,
