...
def test_non_unique_mask_subtraction(stairs1, stairs2):
...
def test_unique_non_overlapping_mask_subtraction(stairs1, stairs2):
    result = stairs1 - stairs2
    expected = pd.Series(
        {
            -4.0: -1.75,
...
def test_unique_adjacent_mask_subtraction(stairs1, stairs2):
    result = stairs1 - stairs2
...
def test_unique_adjacent_nan_initial_mask_subtraction(stairs1, stairs2):
    result = stairs1 - stairs2
...
def test_unique_overlapping_mask_subtraction(stairs1, stairs2):
    result = stairs1 - stairs2
    expected = pd.Series({-4.0: -1.75, -2.0: 0.0, 1.0: np.nan, 9.0: -5.5, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
...
def test_unique_overlapping_nan_initial_mask_subtraction(stairs1, stairs2):
    result = stairs1 - stairs2
    expected = pd.Series({9.0: -5.5, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
