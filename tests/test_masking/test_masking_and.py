...
def test_non_unique_mask_and(stairs1, stairs2):
    result = stairs1.logical_and(stairs2)
    expected = pd.Series(
        {-2.0: 1.0, 1.0: np.nan, 3.0: 1.0, 7.0: 0.0, 8.0: 1.0, 10.0: 0.0}
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (s2().mask(sc.Stairs(end=3)), s1()),
        (s1(), s2().mask(sc.Stairs(end=3))),
        (s2(), s1().mask(sc.Stairs(end=3))),
        (s1().mask(sc.Stairs(end=3)), s2().mask(sc.Stairs(end=3))),
        (s2().mask(sc.Stairs(end=3)), s1().mask(sc.Stairs(end=3))),
    ],
)
def test_non_unique_nan_initial_mask_and(stairs1, stairs2):
    result = stairs1.logical_and(stairs2)
    expected = pd.Series({3.0: 1.0, 7.0: 0.0, 8.0: 1.0, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (s2().mask(sc.Stairs(start=1, end=3)).mask(sc.Stairs(start=5, end=9)), s1()),
        (s2().mask(sc.Stairs(start=5, end=9)).mask(sc.Stairs(start=1, end=3)), s1()),
        (s2(), s1().mask(sc.Stairs(start=1, end=3)).mask(sc.Stairs(start=5, end=9))),
        (s2(), s1().mask(sc.Stairs(start=5, end=9)).mask(sc.Stairs(start=1, end=3))),
        (s2().mask(sc.Stairs(start=1, end=3)), s1().mask(sc.Stairs(start=5, end=9))),
        (s2().mask(sc.Stairs(start=5, end=9)), s1().mask(sc.Stairs(start=1, end=3))),
    ],
)
def test_unique_non_overlapping_mask_and(stairs1, stairs2):
    result = stairs1.logical_and(stairs2)
    expected = pd.Series(
        {-2.0: 1.0, 1.0: np.nan, 3.0: 1.0, 5.0: np.nan, 9.0: 1.0, 10.0: 0.0}
    )
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (s2().mask(sc.Stairs(end=3)).mask(sc.Stairs(start=5, end=9)), s1()),
        (s2().mask(sc.Stairs(start=5, end=9)).mask(sc.Stairs(end=3)), s1()),
        (s2(), s1().mask(sc.Stairs(end=3)).mask(sc.Stairs(start=5, end=9))),
        (s2(), s1().mask(sc.Stairs(start=5, end=9)).mask(sc.Stairs(end=3))),
        (s2().mask(sc.Stairs(end=3)), s1().mask(sc.Stairs(start=5, end=9))),
        (s2().mask(sc.Stairs(start=5, end=9)), s1().mask(sc.Stairs(end=3))),
    ],
)
def test_unique_non_overlapping_nan_initial_mask_and(stairs1, stairs2):
    result = stairs1.logical_and(stairs2)
    expected = pd.Series({3.0: 1.0, 5.0: np.nan, 9.0: 1.0, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
    )
    assert np.isnan(result.initial_value)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (s2().mask(sc.Stairs(start=1, end=4)).mask(sc.Stairs(start=4, end=9)), s1()),
        (s2().mask(sc.Stairs(start=4, end=9)).mask(sc.Stairs(start=1, end=4)), s1()),
        (s2(), s1().mask(sc.Stairs(start=1, end=4)).mask(sc.Stairs(start=4, end=9))),
        (s2(), s1().mask(sc.Stairs(start=4, end=9)).mask(sc.Stairs(start=1, end=4))),
        (s2().mask(sc.Stairs(start=1, end=4)), s1().mask(sc.Stairs(start=4, end=9))),
        (s2().mask(sc.Stairs(start=4, end=9)), s1().mask(sc.Stairs(start=1, end=4))),
    ],
)
def test_unique_adjacent_mask_and(stairs1, stairs2):
    result = stairs1.logical_and(stairs2)
    expected = pd.Series({-2.0: 1.0, 1.0: np.nan, 9.0: 1.0, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
    )
    assert result.initial_value == 0
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (s2().mask(sc.Stairs(end=4)).mask(sc.Stairs(start=4, end=9)), s1()),
        (s2().mask(sc.Stairs(start=4, end=9)).mask(sc.Stairs(end=4)), s1()),
        (s2(), s1().mask(sc.Stairs(end=4)).mask(sc.Stairs(start=4, end=9))),
        (s2(), s1().mask(sc.Stairs(start=4, end=9)).mask(sc.Stairs(end=4))),
        (s2().mask(sc.Stairs(end=4)), s1().mask(sc.Stairs(start=4, end=9))),
        (s2().mask(sc.Stairs(start=4, end=9)), s1().mask(sc.Stairs(end=4))),
    ],
)
def test_unique_adjacent_nan_initial_mask_and(stairs1, stairs2):
    result = stairs1.logical_and(stairs2)
    expected = pd.Series({9.0: 1.0, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
    )
    assert np.isnan(result.initial_value)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (s2().mask(sc.Stairs(start=1, end=6)).mask(sc.Stairs(start=4, end=9)), s1()),
        (s2().mask(sc.Stairs(start=4, end=9)).mask(sc.Stairs(start=1, end=6)), s1()),
        (s2(), s1().mask(sc.Stairs(start=1, end=6)).mask(sc.Stairs(start=4, end=9))),
        (s2(), s1().mask(sc.Stairs(start=4, end=9)).mask(sc.Stairs(start=1, end=6))),
        (s2().mask(sc.Stairs(start=1, end=6)), s1().mask(sc.Stairs(start=4, end=9))),
        (s2().mask(sc.Stairs(start=4, end=9)), s1().mask(sc.Stairs(start=1, end=6))),
    ],
)
def test_unique_overlapping_mask_and(stairs1, stairs2):
    result = stairs1.logical_and(stairs2)
    expected = pd.Series({-2.0: 1.0, 1.0: np.nan, 9.0: 1.0, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (s2().mask(sc.Stairs(end=6)).mask(sc.Stairs(start=4, end=9)), s1()),
        (s2().mask(sc.Stairs(start=4, end=9)).mask(sc.Stairs(end=6)), s1()),
        (s2(), s1().mask(sc.Stairs(end=6)).mask(sc.Stairs(start=4, end=9))),
        (s2(), s1().mask(sc.Stairs(start=4, end=9)).mask(sc.Stairs(end=6))),
        (s2().mask(sc.Stairs(end=6)), s1().mask(sc.Stairs(start=4, end=9))),
        (s2().mask(sc.Stairs(start=4, end=9)), s1().mask(sc.Stairs(end=6))),
    ],
)
def test_unique_overlapping_nan_initial_mask_and(stairs1, stairs2):
    result = stairs1.logical_and(stairs2)
    expected = pd.Series({9.0: 1.0, 10.0: 0.0})
    pd.testing.assert_series_equal(
        result.step_values, expected, check_names=False, check_index_type=False,
